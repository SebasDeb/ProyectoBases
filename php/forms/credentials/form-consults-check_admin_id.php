...
<body>
    ...
    <div class="container-general">
        ...
        <div class="box-white">
            <form action="http://localhost/sistema_almacen/php/modules/credentials/bkend-consults-check_admin_id.php" method="POST">
                <div class="form-group">
                    ...
                    <br><br>
                    <label for="admin-password">Ingrese la clave de un administrador</label>
                    <input type="text" class="form-control" id="admin-password" name="admin-password" required placeholder="Ingrese la clave de un administrador" pattern="[0-9]+">
                </div>
